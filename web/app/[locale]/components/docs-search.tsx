    ...
    <div className="px-3 pb-4" data-pagefind-ignore="all">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-md border border-border bg-transparent py-1.5 pl-8 pr-3 text-[13px] transition-colors placeholder:text-muted/40 focus:border-foreground/20 focus:outline-none"
        />
      </div>
      ...
      {showResults && (
        ...
        >
          {statusMessage ? (
            <div className="px-1 py-2 text-[12px] text-muted/60">
              {statusMessage}
            </div>
          ) : (
